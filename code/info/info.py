...
print("Name Similarity Score - mean:", df['name_similarity_score'].mean())
print("Name Similarity Score - std:", df['name_similarity_score'].std())
print("Name Similarity Score - min:", df['name_similarity_score'].min())
print("Name Similarity Score - max:", df['name_similarity_score'].max())
